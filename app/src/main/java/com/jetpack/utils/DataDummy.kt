    ...
    fun generateDummyMovies() : List<MovieEntity> {
        ...
        movies.add(
            MovieEntity("3", "Zootopia", "Determined to prove herself, Officer Judy Hopps, " +
                ...
                "Adventure", "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/hlK0e0wAQ3VLuJcsfIYPvb4JVud.jpg", false)
        )
        ...
        movies.add(
            MovieEntity("4", "A Beautiful Mind", "John Nash is a brilliant but asocial mathematician " +
                ...
                "Drama", "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/zwzWCmH72OSC9NA0ipoqw5Zjya8.jpg", false)
        )
        ...
        movies.add(
            MovieEntity("5", "Jumanji: Welcome to the Jungle", "The tables are turned as four " +
                ...
                "Adventure", "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/pSgXKPU5h6U89ipF7HBYajvYt7j.jpg", false)
        )
        ...
        movies.add(
            MovieEntity("6", "Big Hero 6", "The special bond that develops between plus-sized " +
                ...
                "Action", "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/2mxS4wUimwlLmI1xp6QW6NSU361.jpg", false)
        )
        ...
        movies.add(
            MovieEntity("7", "Home Alone", "Eight-year-old Kevin McCallister makes the most " +
                ...
                "Comedy", "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/9wSbe4CwObACCQvaUVhWQyLR5Vz.jpg", false)
        )
        ...
        movies.add(
            MovieEntity("8", "Psycho-Pass 3: First Inspector", "Inspector Kei Mikhail Ignatov finds " +
                ...
                "Crime", "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/hNvOilYbemMkaVpDktvwAEeH9sz.jpg", false)
        )
        ...
        movies.add(
            MovieEntity("9", "The Conjuring", "Paranormal investigators Ed and Lorraine Warren " +
                ...
                "Horror", "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/wVYREutTvI2tmxr6ujrHT704wGF.jpg", false)
        )
        ...
        movies.add(
            MovieEntity("10", "Five Feet Apart", "Seventeen-year-old Stella spends most of her " +
                ...
                "Fantasy", "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/khQolo0hQCQjByVpfUhkyQtOJSq.jpg", false)
        )
